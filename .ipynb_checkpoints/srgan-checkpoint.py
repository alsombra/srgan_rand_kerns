...
parser.add_argument("--scale_factor", type=int, default=2, help="scale factor of SR")
...
dataloader = DataLoader(
    ImageDataset("/data/antonio/%s/train" % opt.dataset_name, hr_shape=hr_shape, scale_factor=opt.scale_factor),
